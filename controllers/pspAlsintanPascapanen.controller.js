...
module.exports = {
    create: async (req, res) => {
        ...
        try {
            ...
            res.status(201).json(response(201, 'PSP alsintan pascapanen berhasil ditambahkan'));
        } catch (err) {
            console.log(err);
    ...
    getAll: async (req, res) => {
        try {
            ...
            res.status(200).json(response(200, 'Berhasil mendapatkan daftar PSP alsintan pascapanen', { data: pspAlsintanPascapanen, pagination }));
        } catch (err) {
            console.log(err);
    ...
    getOne: async (req, res) => {
        try {
            ...
            if (!pspAlsintanPascapanen) {
                res.status(404).json(response(404, 'Psp alsintan pascapanen tidak dapat ditemukan'));
                return;
            }

            res.status(200).json(response(200, 'Berhasil mendapatkan PSP alsintan pascapanen', pspAlsintanPascapanen));
        } catch (err) {
            console.log(err);
    ...
    update: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json(response(200, 'Berhasil memperbaharui PSP alsintan pascapanen'));
        } catch (err) {
            console.log(err);
    ...
    delete: async (req, res) => {
        ...
        try {
            ...
            await pspAlsintanPascapanen.destroy();

            await transaction.commit();

            res.status(200).json(response(200, 'Berhasil menghapus PSP alsintan pascapanen'));
        } catch (err) {
            console.log(err);
