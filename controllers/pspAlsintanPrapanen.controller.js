...
module.exports = {
    ...
    getAll: async (req, res) => {
        try {
            ...
            res.status(200).json(response(200, 'Get PSP alsintan prapanen successfully', { data: pspAlsintanPrapanen, pagination }));
        } catch (err) {
            console.log(err);
    ...
    getOne: async (req, res) => {
        try {
            ...
            res.status(200).json(response(200, 'Get PSP alsintan prapanen successfully', pspAlsintanPrapanen));
        } catch (err) {
            console.log(err);
    ...
    delete: async (req, res) => {
        ...
        try {
            ...
            res.status(200).json(response(200, 'Delete PSP alsintan prapanen successfully'));
        } catch (err) {
            console.log(err);
